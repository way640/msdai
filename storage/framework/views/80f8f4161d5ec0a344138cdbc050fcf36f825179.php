...
<link href="css/general-541378b38b.css" rel="stylesheet">
    <link href="<?php echo e(asset('css/login_main-137a6f8775.css')); ?>" rel="stylesheet">
</head>
<body style="height:400px">

<script type="text/javascript" async="" src="<?php echo e(asset('js/mv.js')); ?>"></script>
<script type="text/javascript" async="" src="<?php echo e(asset('js/mba.js')); ?>"></script>
        ...
        <div class="page-desc-inner">
            <div class="container">
                <a href="https://www.jimu.com/">
                    <img src="<?php echo e(asset('image/jimu-232871d0cb.png')); ?>">
                </a>
                <h1>登录</h1>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-7">
                <a href="<?php echo e(url('')); ?>" target="">
                        <img alt="登录页活动图" src="<?php echo e(asset('file/07a662f4-3d1d-42d5-8806-084234e29cf0')); ?>">
                    </a>
                </div>

            <div id="login-form" style="height:0">
                <div id="login-form-loading" class="hidden-default"></div>
                <div class="" id="iframe-c">
                   <iframe id="iframe_login" frameborder="0" scrolling="no" marginwidth="0" marginheight="0" onload="formLoadingAction(&#39;loaded&#39;)" onunload="formLoadingAction()" src="../resources/views/user/loginForm">                    </iframe>
                </div>
            </div>
...
<link href="<?php echo e(asset('css/register_main-286e89e052.css')); ?>" rel="stylesheet">
...
<script src="<?php echo e(asset('js/hm.js(1)')); ?>"></script>

<script type="text/javascript" async="" src="<?php echo e(asset('js/dc.js')); ?>"></script>
<script type="text/javascript" async="" src="<?php echo e(asset('js/agt.js')); ?>"></script>
<script type="text/javascript" async="" src="<?php echo e(asset('js/conversion.js')); ?>"></script>
<script type="text/javascript" async="" src="<?php echo e(asset('js/mvl.js')); ?>"></script>
<img src="<?php echo e(asset('image/pv')); ?>" style="display: none; width: 0px; height: 0px;">
</body>
</html>