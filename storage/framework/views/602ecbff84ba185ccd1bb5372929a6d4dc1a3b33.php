    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div>
                    <a href="<?php echo e(url('admin/appo/appoadd')); ?>">
...
<script>
    $(function ( ) {
        function getData( typeInfo ){
            $.ajax({
                type:"get",
                url:"<?php echo e(url('admin/appo/appoinfo')); ?>",
                data:'type='+typeInfo,
                dataType:'json',
        ...
        $.ajax({
            type: "get",
            url: "<?php echo e(url('admin/appo/appoadmininfo')); ?>",
            data: '',
            dataType: 'json',
            success: function (msg) {
                $('.input-sm').html('');
...
//        $('.config-del').click(function(){
            if(confirm('这将删除该分类及它的所有子分类，是否继续？')){
                ...
                $.ajax({
                    type: "get",
                    url: "<?php echo e(url('admin/system/systemdel')); ?>",
