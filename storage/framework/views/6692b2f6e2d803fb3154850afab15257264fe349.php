...
<link href="<?php echo e(asset('css/user_score-dcd057ec95.css')); ?>" rel="stylesheet">
    	...
    	<div class="head">
        	<a class="logo" href="http://www.zdmoney.com"><img src="<?php echo e(asset('image/logo-bg.png')); ?>" /></a>
          	<ul>
            	...
            	<li><a href="<?php echo e(url('home/invest/invest')); ?>">轻松投</a></li>
            	<li><a href="<?php echo e(url('home/borrow/borrow')); ?>">借款</a></li>
				<li><a href="<?php echo e(asset('home/gold/gold')); ?>">贵金属</a></li
                <li class="hot"></li>
				<li style="float:right;"><a href="<?php echo e(asset('home/personal/personal')); ?>">我的积木</a></li>
        	</ul>
        </div>
    </div>
